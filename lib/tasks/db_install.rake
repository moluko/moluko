namespace :db do
  ...
  task :install => :environment do
    ...
    #create theme
    theme = Theme.create :name => 'Moluko 1', :designer => 'Moluko Team', :position => 1

    #create theme pages
    content = File.open('lib/tasks/themes/moluko1/storefront.html'){|f| f.read }
    theme.theme_pages.create :name => 'storefront', :content => content
    content = File.open('lib/tasks/themes/moluko1/product.html'){|f| f.read }
    theme.theme_pages.create :name => 'product', :content => content

    #create theme images
    theme.theme_images.create :data => File.new('lib/tasks/themes/moluko1/storefront.png')
    theme.theme_images.create :data => File.new('lib/tasks/themes/moluko1/product.png')
    theme.theme_images.create :data => File.new('lib/tasks/themes/moluko1/sprite.png')
    theme.theme_images.create :data => File.new('lib/tasks/themes/moluko1/vertical.png')
    theme.theme_images.create :data => File.new('lib/tasks/themes/moluko1/button1_leftmiddle.png')
    theme.theme_images.create :data => File.new('lib/tasks/themes/moluko1/button1_rightmiddle.png')

    #create theme
    theme = Theme.create :name => 'Moluko 2', :designer => 'Moluko Team', :position => 2

    #create theme pages
    content = File.open('lib/tasks/themes/moluko2/storefront.html'){|f| f.read }
    theme.theme_pages.create :name => 'storefront', :content => content
    content = File.open('lib/tasks/themes/moluko2/product.html'){|f| f.read }
    theme.theme_pages.create :name => 'product', :content => content

    #create theme images
    theme.theme_images.create :data => File.new('lib/tasks/themes/moluko2/storefront.png')
    theme.theme_images.create :data => File.new('lib/tasks/themes/moluko2/product.png')
